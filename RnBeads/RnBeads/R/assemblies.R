...
##
hv4.chr <- read.table("/home/bjorn/Documents/test/epiGBS/RnBeads/assemblies/hv4/bs.bed/chromosomes.txt")
##
hv5.chr <- read.table("/home/bjorn/Documents/test/epiGBS/RnBeads/assemblies/hv5/bs.bed/chromosomes.txt")
##
hv6.chr <- read.table("/home/bjorn/Documents/test/epiGBS/RnBeads/assemblies/hv6/bs.bed/chromosomes.txt")
##
hv7.chr <- read.table("/home/bjorn/Documents/test/epiGBS/RnBeads/assemblies/hv7/bs.bed/chromosomes.txt")
##%(chromosomes)s
